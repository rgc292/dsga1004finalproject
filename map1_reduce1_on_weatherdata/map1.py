...
for line in sys.stdin:
    ...
    if data[0:6] != "USUSAF":
        if data[21:23] == "00":
            print '%s/%s/%s,%s,%s\t%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s' % (data[17:19].strip(),data[19:21].strip(),data[13:17].strip(),str(0).strip(),data[23:25].strip(),data[26:29].strip(),data[30:33].strip(),data[34:37].strip(),data[42:45].strip(),data[83:87].strip(),data[89:92].strip(),data[93:99].strip(),data[106:112].strip(),data[113:116].strip(),data[117:120].strip(),data[121:126].strip(),data[127:132].strip(),data[133:138].strip(),data[145:147].strip())
